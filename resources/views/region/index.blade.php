...
<h1 class="text-center text-4xl py-14"> Index Region Page </h1>
    ...
    @foreach($regions as $region)
                    ...
                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b">
                        ...
                        <td class="px-6 py-4 flex gap-4">
                            <a href="{{ route('region.edit', $region->id) }}" class="font-medium text-blue-600 hover:underline">Edit</a>
    ...
    <a href="{{ route('region.create') }}" class=" inline-block mt-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 focus:outline-none">Store</a>
