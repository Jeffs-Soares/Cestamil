...
<h1 class="text-center text-4xl py-14"> Create Region Page </h1>


    <form class="max-w-sm mx-auto" action="{{ route('region.store') }}" method="post">
        @csrf
        @method('post')
        ...
        <div class="mb-5">
            ...
            <input type="text" id="seller" name="seller" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
        </div>
