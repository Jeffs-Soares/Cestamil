<x-app.template>
    ...
    <a href="" class="block w-max col-start-1 col-span-2">
        <div class="p-2 px-4 h-[200px] w-[200px] bg-gray-200 rounded-lg dark:bg-gray-800 flex flex-col gap-6 relative">
            ...
            <p class="text-center text-gray-50 text-5xl absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"> {{ $qtd }} </p>
...
{{--            <p class="text-center text-gray-50 text-5xl absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"> 2 </p>--}}
